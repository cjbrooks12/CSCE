...
//------------------------------------------------------------------------------
    ...
    public:
        ...
        //Added this function to set the color of the window
	void set_color(Fl_Color c) { color(c); }
        ...
        //added these functions to get the dimensions of the window
	int x_winsize() { return decorated_w(); }
	int y_winsize() { return decorated_h(); }
    protected:
        void draw();
